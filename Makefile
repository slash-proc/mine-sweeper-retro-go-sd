# Retro-Go SD — Minesweeper GWHB homebrew
#
#   make PROJECT_KIND=homebrew
#   make docker PROJECT_KIND=homebrew
#
# Upstream game: https://github.com/slipperstree/game-and-watch-mine-sweeper
...
CORE_NAME  := minesweeper
CORE_ENTRY := app_main

CORE_C_SOURCES := \
src/main.c \
src/mine/Src/common.c \
src/mine/Src/control.c \
src/mine/Src/display.c \
src/mine/Src/embMine.c \
src/mine/Src/embMineDevice.c \
src/mine/Src/font.c \
src/mine/Src/gw_draw.c \
src/mine/Src/key.c \
src/mine/Src/myMathUtil.c \
src/mine/Src/saveData.c \
src/mine/Src/mine_platform.c
...
pack: $(TARGET_BIN) $(COVER_JPG)
	...
	$(V)python3 $(PACK_HOMEBREW) \
		...
		--name "Mine Sweeper" --version 1.0.0 \
		--cover $(COVER_JPG) \
		--out $(PACKED_BIN)
