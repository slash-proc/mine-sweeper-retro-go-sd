...
typedef unsigned long       MINE_DWORD;
typedef unsigned char       MINE_BYTE;
typedef unsigned int        MINE_WORD;
typedef unsigned long       COLORREF;

/* Win RGB */
#define COLOR_RGB(r, g, b) ((COLORREF)(((MINE_BYTE)(r) | ((MINE_WORD)((MINE_BYTE)(g)) << 8)) | (((MINE_DWORD)(MINE_BYTE)(b)) << 16)))

#define COLOR_RGBA(r, g, b, a) ((COLORREF)((((MINE_DWORD)(MINE_BYTE)(a)) << 24) | COLOR_RGB(r, g, b)))

/* Win PALETTERGB */
#define COLOR_PALRGB(r, g, b) (0x02000000 | COLOR_RGB(r, g, b))

/* Win PALETTEINDEX */
#define COLOR_PALINDEX(i) ((COLORREF)(0x01000000 | (MINE_DWORD)(MINE_WORD)(i)))

/* Win GetRValue */
#define COLOR_GET_RED(rgb) ((MINE_BYTE)(((MINE_DWORD)(rgb)) & 0xff))

/* Win GetGValue */
#define COLOR_GET_GREEN(rgb) ((MINE_BYTE)(((MINE_DWORD)(((MINE_WORD)(rgb)) >> 8)) & 0xff))

/* Win GetBValue */
#define COLOR_GET_BLUE(rgb) ((MINE_BYTE)(((MINE_DWORD)((rgb) >> 16)) & 0xff))

#define COLOR_GET_ALPHA(rgba) ((MINE_BYTE)(((MINE_DWORD)((rgba) >> 24)) & 0xff))

/*
 * 24 bits color <=> 16 bits color
 */
#define RGB888toRGB565(r, g, b) ((MINE_WORD)((((MINE_WORD)(r) << 8) & 0xF800) | ((((MINE_WORD)(g)) << 3) & 0x7E0) | (((MINE_WORD)(b)) >> 3)))
#define RGBtoRGB565(rgb) ((MINE_WORD)(((((MINE_WORD)((rgb) >> 3)) & (0x1F)) << 11) | ((((MINE_WORD)((rgb) >> 10)) & (0x3F)) << 5) | (((MINE_WORD)((rgb) >> 19)) & (0x1F))))


#define RGB888toRGB555(r, g, b) ((MINE_WORD)(((((MINE_WORD)(r)) << 7) & 0x7C00) | ((((MINE_WORD)(g)) << 2) & 0x3E0) | (((MINE_WORD)(b)) >> 3)))
#define RGBtoRGB555(rgb) ((MINE_WORD)(((((MINE_WORD)((rgb) >> 3)) & (0x1F)) << 10) | ((((MINE_WORD)((rgb) >> 11)) & (0x1F)) << 5) | (((MINE_WORD)((rgb) >> 19)) & (0x1F))))
#define RGB555toRGB(rgb555) ((MINE_DWORD)(((MINE_BYTE)(((rgb555) >> 7) & 0xF8) | ((MINE_WORD)((MINE_BYTE)(((rgb555) >> 2) & 0xF8)) << 8)) | (((MINE_DWORD)(MINE_BYTE)(((rgb555) << 3) & 0xF8)) << 16)))
#define RGB565toRGB(rgb565) ((MINE_DWORD)(((MINE_BYTE)((((rgb565)&0xF800) >> 11) << 3) | ((MINE_WORD)((MINE_BYTE)((((rgb565)&0x07E0) >> 5) << 2)) << 8)) | (((MINE_DWORD)(MINE_BYTE)(((rgb565)&0x001F) << 3)) << 16)))
